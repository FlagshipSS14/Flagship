...
public sealed partial class UnremovableClothingSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<FlagShip.Shared.Clothing.UnremovableClothingRemoverComponent, AfterInteractEvent>(OnInteract);
    }
    ...
    private void OnInteract(EntityUid uid, FlagShip.Shared.Clothing.UnremovableClothingRemoverComponent component, ref AfterInteractEvent eventArgs)
    {
    ...
    private void HandleRemovability(EntityUid targetUid, FlagShip.Shared.Clothing.UnremovableClothingRemoverComponent component, ref AfterInteractEvent eventArgs)
    {
