...
namespace Content.FlagShip.Shared.ArmorPiercing;
...
public sealed class ArmorPiercingSystem : EntitySystem
{
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<FlagShip.Shared.ArmorPiercing.ArmorPiercingComponent, PreventCollideEvent>(OnPreventCollide);
    }

    private void OnPreventCollide(Entity<FlagShip.Shared.ArmorPiercing.ArmorPiercingComponent> ent, ref PreventCollideEvent args)
    {
        var comp = ent.Comp;
