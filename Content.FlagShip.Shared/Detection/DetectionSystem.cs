...
namespace Content.FlagShip.Shared.Detection;
...
public sealed partial class DetectionSystem : EntitySystem
{
    ...
    public DetectionLevel IsGridDetected(Entity<MapGridComponent?> grid, EntityUid byUid)
    {
        ...
        var comp = EnsureComp<FlagShip.Shared.Detection.DetectionRangeMultiplierComponent>(byUid);
        ...
        if (TryComp<FlagShip.Shared.Detection.DetectedAtRangeMultiplierComponent>(grid, out var compAt))
        {
