...
namespace Content.FlagShip.Shared.CloakHeat.Systems;
...
public sealed partial class CloakHeatSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<FlagShip.Shared.CloakHeat.CloakHeatComponent, ComponentInit>(OnComponentInit);
    }
    ...
    public override void Update(float frameTime)
    {
        ...
        var query = EntityQueryEnumerator<FlagShip.Shared.CloakHeat.CloakHeatComponent, IFFComponent>();
    ...
    private void OnComponentInit(EntityUid uid, FlagShip.Shared.CloakHeat.CloakHeatComponent component, ComponentInit args)
    {
