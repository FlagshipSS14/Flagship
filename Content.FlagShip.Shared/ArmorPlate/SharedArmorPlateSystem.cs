...
public sealed partial class SharedArmorPlateSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<FlagShip.Shared.ArmorPlate.ArmorPlateHolderComponent, EntInsertedIntoContainerMessage>(OnPlateInserted);
        SubscribeLocalEvent<FlagShip.Shared.ArmorPlate.ArmorPlateHolderComponent, EntRemovedFromContainerMessage>(OnPlateRemoved);
        SubscribeLocalEvent<FlagShip.Shared.ArmorPlate.ArmorPlateHolderComponent, GotEquippedEvent>(OnEquippedArmor);
        SubscribeLocalEvent<FlagShip.Shared.ArmorPlate.ArmorPlateHolderComponent, GotUnequippedEvent>(OnUnequippedArmor);
        SubscribeLocalEvent<FlagShip.Shared.ArmorPlate.ArmorPlateHolderComponent, ExaminedEvent>(OnExamined);
        SubscribeLocalEvent<FlagShip.Shared.ArmorPlate.ArmorPlateHolderComponent, InventoryRelayedEvent<RefreshMovementSpeedModifiersEvent>>(OnRefreshMoveSpeed);
    ...
    public void OnBeforeDamageChanged(Entity<ArmorPlateProtectedComponent> ent, ref BeforeDamageChangedEvent args)
    {
        ...
        foreach (var slot in slots)
        {
            ...
            if (!TryComp<FlagShip.Shared.ArmorPlate.ArmorPlateHolderComponent>(equipped, out var holder))
                continue;
    ...
    private void AbsorbDamage(
        EntityUid wearer,
        EntityUid armorUid,
        FlagShip.Shared.ArmorPlate.ArmorPlateHolderComponent holder,
    ...
    private void OnPlateInserted(Entity<FlagShip.Shared.ArmorPlate.ArmorPlateHolderComponent> ent, ref EntInsertedIntoContainerMessage args)
    {
    ...
    private void OnPlateRemoved(Entity<FlagShip.Shared.ArmorPlate.ArmorPlateHolderComponent> ent, ref EntRemovedFromContainerMessage args)
    {
        if (args.Container.ID != StorageComponent.ContainerId)
            return;
    ...
    private void OnExamined(Entity<FlagShip.Shared.ArmorPlate.ArmorPlateHolderComponent> ent, ref ExaminedEvent args)
    {
        var holder = ent.Comp;
    ...
    private void OnRefreshMoveSpeed(EntityUid uid, FlagShip.Shared.ArmorPlate.ArmorPlateHolderComponent component, InventoryRelayedEvent<RefreshMovementSpeedModifiersEvent> args)
    {
    ...
    /// </summary>
    private void SetActivePlate(EntityUid holderUid, EntityUid plateUid, ArmorPlateItemComponent plateComp, FlagShip.Shared.ArmorPlate.ArmorPlateHolderComponent holder)
    {
    ...
    /// </summary>
    private void ClearActivePlate(EntityUid holderUid, FlagShip.Shared.ArmorPlate.ArmorPlateHolderComponent holder)
    {
    ...
    /// </summary>
    public bool TryGetActivePlate(Entity<FlagShip.Shared.ArmorPlate.ArmorPlateHolderComponent?> holder, out Entity<ArmorPlateItemComponent> plate)
    {
        plate = default;
    ...
    private void OnPlateDestroyed(Entity<ArmorPlateItemComponent> ent, ref EntityTerminatingEvent args)
    {
        ...
        if (!TryComp<FlagShip.Shared.ArmorPlate.ArmorPlateHolderComponent>(holderUid, out var holder))
            return;
    ...
    /// </summary>
    private void OnEquippedArmor(Entity<FlagShip.Shared.ArmorPlate.ArmorPlateHolderComponent> armor, ref GotEquippedEvent args)
    {
    ...
    /// </summary>
    private void OnUnequippedArmor(Entity<FlagShip.Shared.ArmorPlate.ArmorPlateHolderComponent> armor, ref GotUnequippedEvent args)
    {
        if (TryGetActivePlate((armor.Owner, armor.Comp), out _))
        {
    ...
    private void RefreshPlateProtection(EntityUid armorUid)
    {
        ...
        if (!TryComp<FlagShip.Shared.ArmorPlate.ArmorPlateHolderComponent>(armorUid, out var holder))
            return;
