...
namespace Content.FlagShip.Shared.Pirate.Components;
...
{
    public List<FlagShip.Shared.Pirate.PirateBountyData> Bounties;
    public TimeSpan UntilNextSkip;

    public PirateBountyConsoleState(List<FlagShip.Shared.Pirate.PirateBountyData> bounties, TimeSpan untilNextSkip)
    {
        Bounties = bounties;
