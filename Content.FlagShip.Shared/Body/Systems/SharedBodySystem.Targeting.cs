...
using Content.FlagShip.Shared.Targeting;
...
namespace Content.FlagShip.Shared.Body.Systems;
...
public partial class SharedBodySystem
{
    ...
    {
        private readonly FlagShip.Shared.Body.Systems.SharedBodySystem _self;
        private readonly Entity<BodyPartComponent> _ent;
        public IntegrityJob(FlagShip.Shared.Body.Systems.SharedBodySystem self, Entity<BodyPartComponent> ent, double maxTime, CancellationToken cancellation = default) : base(maxTime, cancellation)
        {
            _self = self;
            _ent = ent;
        }

        public IntegrityJob(FlagShip.Shared.Body.Systems.SharedBodySystem self, Entity<BodyPartComponent> ent, double maxTime, IStopwatch stopwatch, CancellationToken cancellation = default) : base(maxTime, stopwatch, cancellation)
        {
            _self = self;
            _ent = ent;
        }
    ...
    private void OnPartDamageModify(Entity<BodyPartComponent> partEnt, ref DamageModifyEvent args)
    {
        ...
        if (Content.Shared.Prototypes.TryIndex<DamageModifierSetPrototype>("PartDamage", out var partModifierSet))
