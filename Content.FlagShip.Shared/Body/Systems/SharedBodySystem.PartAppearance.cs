...
public partial class SharedBodySystem
{
    ...
    {
        var speciesProto = Content.Shared.Prototypes.Index(bodyAppearance.Species);
        var baseSprites = Content.Shared.Prototypes.Index<HumanoidSpeciesBaseSpritesPrototype>(speciesProto.SpriteSet);
        ...
        BodyPartAppearanceComponent component)
    {
        ...
        if (component.EyeColor != null)
        {
            ...
            _humanoid.SetLayerVisibility((target, bodyAppearance), HumanoidVisualLayers.Eyes, true, null);
        }
