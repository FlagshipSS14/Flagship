using Content.FlagShip.Shared.Detection;
using Content.FlagShip.Shared.Ships;
...
public sealed partial class ThermalSignatureSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<FlagShip.Server.Detection.MachineThermalSignatureComponent, GetThermalSignatureEvent>(OnMachineGetSignature);
        SubscribeLocalEvent<FlagShip.Server.Detection.PassiveThermalSignatureComponent, GetThermalSignatureEvent>(OnPassiveGetSignature);
    ...
    private void OnMachineGetSignature(Entity<FlagShip.Server.Detection.MachineThermalSignatureComponent> ent, ref GetThermalSignatureEvent args)
    {
        if (_power.IsPowered(ent.Owner))
            args.Signature += ent.Comp.Signature;
    }

    private void OnPassiveGetSignature(Entity<FlagShip.Server.Detection.PassiveThermalSignatureComponent> ent, ref GetThermalSignatureEvent args)
    {
        args.Signature += ent.Comp.Signature;
    }
