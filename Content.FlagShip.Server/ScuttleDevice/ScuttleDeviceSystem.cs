using Content.FlagShip.Shared.ScuttleDevice;
...
namespace Content.FlagShip.Server.ScuttleDevice;
...
public sealed partial class ScuttleDeviceSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<FlagShip.Server.ScuttleDevice.ScuttleDeviceComponent, ComponentInit>(OnInit);
        SubscribeLocalEvent<FlagShip.Server.ScuttleDevice.ScuttleDeviceComponent, ExaminedEvent>(OnExaminedEvent);
        SubscribeLocalEvent<FlagShip.Server.ScuttleDevice.ScuttleDeviceComponent, GetVerbsEvent<AlternativeVerb>>(OnAlternateVerb);
        SubscribeLocalEvent<FlagShip.Server.ScuttleDevice.ScuttleDeviceComponent, ScuttleDisarmDoAfterEvent>(OnDisarmDoAfter);
        SubscribeLocalEvent<FlagShip.Server.ScuttleDevice.ScuttleDeviceComponent, ScuttleArmDoAfterEvent>(OnArmDoAfter);
        SubscribeLocalEvent<FlagShip.Server.ScuttleDevice.ScuttleDeviceComponent, AnchorStateChangedEvent>(OnAnchorChange);
        SubscribeLocalEvent<FlagShip.Server.ScuttleDevice.ScuttleDeviceComponent, UnanchorAttemptEvent>(OnUnanchorAttempt);
        SubscribeLocalEvent<FlagShip.Server.ScuttleDevice.ScuttleDeviceComponent, PriceCalculationEvent>(OnGetPrice);
    }

    private void OnInit(Entity<FlagShip.Server.ScuttleDevice.ScuttleDeviceComponent> ent, ref ComponentInit args)
    {
        ent.Comp.RemainingTime = ent.Comp.Timer;
    }

    private void OnExaminedEvent(Entity<FlagShip.Server.ScuttleDevice.ScuttleDeviceComponent> ent, ref ExaminedEvent args)
    {
    ...
    private void OnAlternateVerb(Entity<FlagShip.Server.ScuttleDevice.ScuttleDeviceComponent> ent, ref GetVerbsEvent<AlternativeVerb> args)
    {
    ...
    private void OnDisarmDoAfter(Entity<FlagShip.Server.ScuttleDevice.ScuttleDeviceComponent> ent, ref ScuttleDisarmDoAfterEvent args)
    {
    ...
    private void OnArmDoAfter(Entity<FlagShip.Server.ScuttleDevice.ScuttleDeviceComponent> ent, ref ScuttleArmDoAfterEvent args)
    {
        if (args.Handled || args.Cancelled)
            return;
    ...
    private void OnAnchorChange(Entity<FlagShip.Server.ScuttleDevice.ScuttleDeviceComponent> ent, ref AnchorStateChangedEvent args)
    {
        if (ent.Comp.DisarmOnUnanchor && !args.Anchored)
            DisarmBomb((ent, ent.Comp));
    }

    private void OnUnanchorAttempt(Entity<FlagShip.Server.ScuttleDevice.ScuttleDeviceComponent> ent, ref UnanchorAttemptEvent args)
    {
        if (args.Cancelled)
            return;
    ...
    private void OnGetPrice(Entity<FlagShip.Server.ScuttleDevice.ScuttleDeviceComponent> ent, ref PriceCalculationEvent args)
    {
    ...
    public override void Update(float frameTime)
    {
        ...
        var query = EntityQueryEnumerator<FlagShip.Server.ScuttleDevice.ScuttleDeviceComponent>();
    ...
    private void TickCooldown(Entity<FlagShip.Server.ScuttleDevice.ScuttleDeviceComponent?> ent, float frameTime)
    {
    ...
    private void TickTimer(Entity<FlagShip.Server.ScuttleDevice.ScuttleDeviceComponent?> ent, float frameTime)
    {
        if (!Resolve(ent, ref ent.Comp))
            return;
    ...
    /// </summary>
    public void ArmBomb(Entity<FlagShip.Server.ScuttleDevice.ScuttleDeviceComponent?> ent)
    {
        if (!Resolve(ent, ref ent.Comp))
            return;
    ...
    /// </summary>
    public void DisarmBomb(Entity<FlagShip.Server.ScuttleDevice.ScuttleDeviceComponent?> ent)
    {
        if (!Resolve(ent, ref ent.Comp))
            return;
    ...
    /// </summary>
    public void ActivateBomb(Entity<FlagShip.Server.ScuttleDevice.ScuttleDeviceComponent?> ent)
    {
        if (!Resolve(ent, ref ent.Comp))
            return;
    ...
    private void ArmBombDoafter(Entity<FlagShip.Server.ScuttleDevice.ScuttleDeviceComponent> ent, EntityUid user)
    {
    ...
    private void DisarmBombDoafter(Entity<FlagShip.Server.ScuttleDevice.ScuttleDeviceComponent> ent, EntityUid user)
    {
    ...
    private void UpdateAppearance(Entity<FlagShip.Server.ScuttleDevice.ScuttleDeviceComponent> ent)
    {
