...
using Content.FlagShip.Shared.ShuttleRecords.Components;
using Content.FlagShip.Shared.ShuttleRecords.Events;
...
namespace Content.FlagShip.Server.ShuttleRecords;
