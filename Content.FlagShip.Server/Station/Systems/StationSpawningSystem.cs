...
using Content.FlagShip.Shared.Bank.Components; // DeltaV
using Content.FlagShip.Server.MonoCoins; // Mono
using Content.FlagShip.Server.Bank; // Frontier
using Content.Server.Preferences.Managers; // Frontier
using System.Linq;
using Content.Shared.NameIdentifier; // Frontier
using Content.FlagShip.Shared;
