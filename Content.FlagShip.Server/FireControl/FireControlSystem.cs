...
public sealed partial class FireControlSystem : EntitySystem
{
    ...
    private EntityQuery<FlagShip.Server.SpaceArtillery.Components.SpaceArtilleryComponent> _artilleryQuery;
    ...
    public override void Initialize()
    {
        ...
        _artilleryQuery = GetEntityQuery<FlagShip.Server.SpaceArtillery.Components.SpaceArtilleryComponent>();
    ...
    public bool CanFireWeapons(EntityUid grid)
    {
        if (TerminatingOrDeleted(grid)
            ...
            || HasComp<FlagShip.Server.SpaceArtillery.Components.SpaceArtilleryDisabledGridComponent>(grid)
        )
            return false;
