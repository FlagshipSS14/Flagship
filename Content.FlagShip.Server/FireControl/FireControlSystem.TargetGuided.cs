using System.Linq;
using Content.FlagShip.Shared.FireControl;
...
{
    [Dependency] private FlagShip.Server.Projectiles.TargetGuided.TargetGuidedSystem _targetGuided = null!;
    ...
    private void InitializeTargetGuided()
    {
        ...
        SubscribeLocalEvent<FlagShip.Server.Projectiles.TargetGuided.TargetGuidedComponent, ComponentShutdown>(OnGuidedMissileShutdown);
    ...
    private void OnTargetGuidedShot(EntityUid uid, GunComponent component, AmmoShotEvent args)
    {
        ...
        {
            if (!TryComp<FlagShip.Server.Projectiles.TargetGuided.TargetGuidedComponent>(projectileUid, out var guidedComp))
                continue;
    ...
    /// </summary>
    private void OnGuidedMissileShutdown(EntityUid uid, FlagShip.Server.Projectiles.TargetGuided.TargetGuidedComponent component, ComponentShutdown args)
    {
    ...
    public void OnGuidanceUpdate(EntityUid consoleUid, EntityCoordinates targetCoordinates)
    {
        ...
        {
            if (!TryComp<FlagShip.Server.Projectiles.TargetGuided.TargetGuidedComponent>(missile, out var guidedComp))
                continue;
    ...
    public override void Update(float frameTime)
    {
        ...
        {
            if (!TryComp<FlagShip.Server.Projectiles.TargetGuided.TargetGuidedComponent>(missileUid, out var guidedComp) ||
