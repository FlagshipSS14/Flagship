...
using Content.FlagShip.Server.SpaceArtillery;
...
using SpaceArtilleryComponent = Content.FlagShip.Server.SpaceArtillery.Components.SpaceArtilleryComponent;
...
public sealed partial class SpaceArtillerySystem : EntitySystem
{
    ...
    [Dependency] private FireControl.FireControlSystem _fireControl = default!;
    [Dependency] private AmmoLoader.AmmoLoaderSystem _ammoLoader = default!;
    ...
    private void TryFireArtillery(EntityUid uid, TransformComponent xform, SpaceArtilleryComponent component)
    {
        ...
        if (HasComp<Components.SpaceArtilleryDisabledGridComponent>(parentGrid) || !xform.Anchored)
        {
            return;
        }
    ...
    {
        if (!TryComp<FireControl.FireControllableComponent>(uid, out var controllable))
            return;
