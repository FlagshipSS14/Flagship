...
using Content.FlagShip.Server.AmmoLoader;
using Content.FlagShip.Server.FireControl;
using Content.Server.Power.Components;
using Content.Shared.DeviceLinking.Events;
using Content.Server.DeviceLinking.Systems;
using Content.Server.Power.EntitySystems;
using Content.Server.Weapons.Ranged.Systems;
using Content.FlagShip.Shared.AmmoLoader;
using Content.FlagShip.Shared.ShipGuns;
using Content.FlagShip.Shared.SpaceArtillery;
...
using Content.FlagShip.Server.SpaceArtillery.Components;

namespace Content.FlagShip.Server.SpaceArtillery;
...
public sealed partial class SpaceArtillerySystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<Components.SpaceArtilleryComponent, AmmoShotEvent>(OnShotEvent);
        SubscribeLocalEvent<Components.SpaceArtilleryComponent, PowerChangedEvent>(OnApcChanged);
        SubscribeLocalEvent<Components.SpaceArtilleryComponent, OnEmptyGunShotEvent>(OnEmptyShotEvent);
        SubscribeLocalEvent<Components.SpaceArtilleryComponent, SignalReceivedEvent>(OnSignalReceived);
        SubscribeLocalEvent<Components.SpaceArtilleryComponent, ChargeChangedEvent>(OnBatteryChargeChanged);
    ...
    private void OnSignalReceived(EntityUid uid, Components.SpaceArtilleryComponent component, ref SignalReceivedEvent args)
    {
    ...
    private void OnApcChanged(EntityUid uid, Components.SpaceArtilleryComponent component, ref PowerChangedEvent args)
    {
    ...
    private void OnBatteryChargeChanged(EntityUid uid, Components.SpaceArtilleryComponent component, ref ChargeChangedEvent args)
    {
    ...
    private void TryFireArtillery(EntityUid uid, TransformComponent xform, Components.SpaceArtilleryComponent component)
    {
    ...
    private void OnShotEvent(EntityUid uid, Components.SpaceArtilleryComponent component, AmmoShotEvent args)
    {
    ...
    private void OnEmptyShotEvent(EntityUid uid, Components.SpaceArtilleryComponent component, OnEmptyGunShotEvent args)
    {
        OnMalfunction(uid, component);
    }

    private void OnMalfunction(EntityUid uid, Components.SpaceArtilleryComponent component)
    {
    }
