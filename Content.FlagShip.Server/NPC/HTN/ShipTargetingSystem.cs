...
using Content.FlagShip.Server.NPC.HTN;
using Content.FlagShip.Server.Projectiles.TargetSeeking;
...
namespace Content.FlagShip.Server.NPC.HTN;

public sealed partial class ShipTargetingSystem : EntitySystem
{
    [Dependency] private EntityLookupSystem _lookup = default!;
    [Dependency] private FireControl.FireControlSystem _cannon = default!;
    [Dependency] private SharedGunSystem _gun = default!;
    [Dependency] private SharedPhysicsSystem _physics = default!;
    [Dependency] private SharedTransformSystem _transform = default!;
    [Dependency] private FlagShip.Server.Projectiles.TargetSeeking.TargetSeekingSystem _seeking = default!;

    [Dependency] private EntityQuery<GunComponent> _gunQuery;
    [Dependency] private EntityQuery<PhysicsComponent> _physQuery;

    private HashSet<Entity<FireControl.FireControllableComponent>> _cannons = new();
