...
namespace Content.FlagShip.Server.NPC.HTN.Operators;
...
public sealed partial class ShipFireGunsOperator : HTNOperator, IHtnConditionalShutdown
{
    ...
    private FlagShip.Server.NPC.HTN.ShipTargetingSystem _targeting = default!;
    ...
    public override void Initialize(IEntitySystemManager sysManager)
    {
        ...
        _targeting = sysManager.GetEntitySystem<FlagShip.Server.NPC.HTN.ShipTargetingSystem>();
    }
