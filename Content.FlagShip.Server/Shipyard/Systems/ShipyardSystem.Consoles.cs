...
using Content.FlagShip.Server.Bank;
using Content.FlagShip.Server.Shipyard.Components;
using Content.FlagShip.Server.ShuttleRecords;
using Content.FlagShip.Shared.Bank.Components;
using Content.FlagShip.Shared.Shipyard;
using Content.FlagShip.Shared.Shipyard.Events;
using Content.FlagShip.Shared.Shipyard.BUI;
using Content.FlagShip.Shared.Shipyard.Prototypes;
using Content.FlagShip.Shared.Shipyard.Components;
...
using static Content.FlagShip.Shared.Shipyard.Components.ShuttleDeedComponent;
using Content.Server.Shuttles.Components;
using Content.FlagShip.Server.Station.Components;
using System.Text.RegularExpressions;
using Content.FlagShip.Server.Shipyard;
...
using Content.FlagShip.Shared.Ships.Components;
using Content.FlagShip.Shared.Shipyard;
using Content.Shared.Tag;
using Robust.Shared.Timing;

namespace Content.FlagShip.Server.Shipyard.Systems;
