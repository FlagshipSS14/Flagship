...
namespace Content.FlagShip.Server.Temperature.Systems;
...
public sealed partial class EntityRadiusHeaterSystem : EntitySystem
{
    ...
    public override void Update(float frameTime)
    {
        ...
        var eqe = EntityQueryEnumerator<Components.EntityRadiusHeaterComponent>();
    ...
    public float CalculateThermalEnergy(Entity<TemperatureComponent> ent,
        ...
        Components.EntityRadiusHeaterComponent comp)
    {
