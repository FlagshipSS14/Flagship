using Content.FlagShip.Client.Contraband.UI;
using Content.FlagShip.Shared.Contraband.BUI;
using Content.FlagShip.Shared.Contraband.Components;
using Content.FlagShip.Shared.Contraband.Events;

namespace Content.FlagShip.Client.Contraband.BUI;
