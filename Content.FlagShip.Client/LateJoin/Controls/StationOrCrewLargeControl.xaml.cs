...
using Content.FlagShip.Client.LateJoin.Extensions;
using Content.FlagShip.Client.LateJoin.Interfaces;
using Content.FlagShip.Client.LateJoin.Windows;
using Robust.Client.AutoGenerated;
using Robust.Client.UserInterface.Controls;
using Robust.Client.UserInterface.XAML;

namespace Content.FlagShip.Client.LateJoin.Controls;
...
public sealed partial class StationOrCrewLargeControl : PickerControl
{
    ...
    public Action<PickerWindow.PickerType>? OnTabChange;
    ...
    {
        OnTabChange?.Invoke(PickerWindow.PickerType.Station);
    }

    private void CrewButtonOnOnPressed(BaseButton.ButtonEventArgs obj)
    {
        OnTabChange?.Invoke(PickerWindow.PickerType.Crew);
    }
}
