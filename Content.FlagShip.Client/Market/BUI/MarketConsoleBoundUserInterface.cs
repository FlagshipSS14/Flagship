using Content.FlagShip.Client.Market.UI;
using Content.FlagShip.Shared.Market.BUI;
using Content.FlagShip.Shared.Market.Events;
using JetBrains.Annotations;
using static Robust.Client.UserInterface.Controls.BaseButton;

namespace Content.FlagShip.Client.Market.BUI;
