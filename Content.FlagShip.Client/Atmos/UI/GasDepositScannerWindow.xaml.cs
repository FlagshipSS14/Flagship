...
namespace Content.FlagShip.Client.Atmos.UI
{
    ...
    public sealed partial class GasDepositScannerWindow : DefaultWindow
    {
        ...
        public void Populate(GasDepositScannerComponent.GasDepositScannerUserMessage msg)
        {
            if (msg.Error != null)
            {
