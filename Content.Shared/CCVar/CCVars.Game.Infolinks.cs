...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<string> InfoLinksDiscord =
        CVarDef.Create("infolinks.discord", "TJ6MsWjQ5x", CVar.SERVER | CVar.REPLICATED);
    ...
    public static readonly CVarDef<string> InfoLinksGithub =
        CVarDef.Create("infolinks.github", "https://github.com/FlagshipSS14/Flagship", CVar.SERVER | CVar.REPLICATED);
